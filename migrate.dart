...
void main() async {
  ...
  final fileMoveMap = {
    ...
    'lib/engine/affordability_engine.dart':
        'lib/core/engine/affordability_engine.dart',
    ...
    'lib/models/user_account.dart':
        'lib/features/auth/models/user_account.dart',
    'lib/models/user_account.g.dart':
        'lib/features/auth/models/user_account.g.dart',
    'lib/models/business_account.dart':
        'lib/features/auth/models/business_account.dart',
    'lib/models/business_account.g.dart':
        'lib/features/auth/models/business_account.g.dart',
    'lib/services/auth_service.dart':
        'lib/features/auth/services/auth_service.dart',
    // Consumer Models & Controllers
    'lib/screens/consumer/add_installment_controller.dart':
        'lib/features/consumer/controllers/add_installment_controller.dart',
    'lib/models/installment.dart':
        'lib/features/consumer/models/installment.dart',
    'lib/models/installment.g.dart':
        'lib/features/consumer/models/installment.g.dart',
    'lib/models/enums.dart': 'lib/features/consumer/models/enums.dart',
    'lib/models/late_fee_rule.dart':
        'lib/features/consumer/models/late_fee_rule.dart',
    'lib/models/late_fee_rule.g.dart':
        'lib/features/consumer/models/late_fee_rule.g.dart',
  };
  ...
  _moveDirectoryContents(
    'lib/screens/consumer',
    'lib/features/consumer/screens',
  );
  _moveDirectoryContents(
    'lib/screens/merchant',
...
void _refactorImportsInFile(File file) {
  ...
  final relativeImportRegex = RegExp(
    "import\\s+['\"](\\.\\./)+((models|services|engine)/[^'\"]+)['\"];",
  );
  ...
  for (final match in matches) {
    ...
    } else if (pathSuffix.contains('user_account') ||
        pathSuffix.contains('business_account') ||
        pathSuffix.contains('auth_service')) {
