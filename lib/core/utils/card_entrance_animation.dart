...
const Duration kCardAnimDuration = Duration(milliseconds: 280);
...
const Duration kCardInitialDelay = Duration(milliseconds: 100);
const Duration kCardStaggerStep = Duration(milliseconds: 80);
